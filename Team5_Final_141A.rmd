...
Each brain region's probe obtains data from the neurons within the region to determine when these neurons fire. We consider the number of neurons within each respective region.
